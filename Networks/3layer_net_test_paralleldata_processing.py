...
f = open('Bond_Count_Report_0.004_4096.txt' , 'w',0)
sys.stdout = f
...
totaltrain_batch = 2#len(train_items)/batch_size
...
with tf.Session(config=config) as sess:
	...
	file_append = open('Final_Report.txt' , 'a+')
...
plt.savefig('Bond_Count_Report_0.004_4096.png')
plt.close()