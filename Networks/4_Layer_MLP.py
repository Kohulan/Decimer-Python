...
'''
#Implementation of parallelized data reading on a 2 Hidden layer Perceptron
...
# Network Parameters
n_hidden_1 = 1024 # 1st layer 
n_hidden_2 = 1024 # 2nd layer 
n_input = 512*512 # Data input (Image shape: 512 * 512)
n_classes = 133 # Bond_Count
...
def test_array_build():
	...
	return result
# Saves decompressed test data in memory
...
plt.savefig('Bond_Count_Report_0.004_modified_2048.png')
plt.close()
